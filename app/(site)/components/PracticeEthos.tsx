export function PracticeEthos() {
  return (
    <>
      <section className="min-h-[75vh] flex flex-col items-center justify-center space-y-8 px-4 pt-10 pb-14 text-center text-[rgba(95,105,109,1)]">
      ...
      <section className="px-4 py-10 text-center text-[rgba(95,105,109,1)] bg-white">
